Desenvolvido por Mateus Santana Conecte-se comigo no LinkedIn
"""
...
[file-tag: code-generated-file-0-1779748888649397047]

Aqui está o código do seu `README.md` simples, direto e focado no seu perfil de Infra/Segurança. Para colocar no seu repositório `cyber-sentinel`, basta criar um novo arquivo com o nome exatamente **`README.md`** lá na pasta do seu VS Code, colar o texto abaixo dentro dele e dar o push:
